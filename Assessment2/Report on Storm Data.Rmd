...
# it is assumed that 'repdata-data-StormData.csv' is in the working directory
...
# write the cleaner data set to file, are read from it. This will improve speed of future calculations
